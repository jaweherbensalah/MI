...
public class Achat implements Serializable{
	 ...
	 */
	public Achat(Long id, Date datedachat, String history, tn.mi.spring.entities.Payementmode payementmode,
			tn.mi.spring.entities.Payementperiode payementperiode, String remarque, String recomendationLetter) {
		super();
		this.id = id;
		this.datedachat = datedachat;
		this.history = history;
	 ...
	 * @param recomendationLetter
	 */
	public Achat(Date datedachat, String history, tn.mi.spring.entities.Payementmode payementmode,
			tn.mi.spring.entities.Payementperiode payementperiode, String remarque, String recomendationLetter) {
		super();
		this.datedachat = datedachat;
		this.history = history;
