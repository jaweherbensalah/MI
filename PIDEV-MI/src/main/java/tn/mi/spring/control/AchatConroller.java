...
import tn.mi.spring.service.AchatService;
import tn.mi.spring.service.AnnReviewService;
import tn.mi.spring.service.AnnService;
import tn.mi.spring.service.NotificationServiceImpl;
import tn.mi.spring.service.UserServiceImpl;
import tn.mi.spring.entities.Achat;
import tn.mi.spring.entities.Payementmode;
import tn.mi.spring.entities.Payementperiode;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.context.annotation.Scope;
import org.springframework.stereotype.Controller;
import tn.mi.spring.control.UserControllerImpl;
...
public class AchatConroller {
	...
	public String addAchat() {
		...
		if (userController.dologin()==navigateTo )
			...
			User currentuser= userController.getU();
